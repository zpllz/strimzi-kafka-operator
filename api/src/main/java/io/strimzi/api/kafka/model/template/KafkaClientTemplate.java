...
@EqualsAndHashCode
public class KafkaClientTemplate implements Serializable, UnknownPropertyPreserving {
    ...
    @Description("Template for Kafka Client `Deployment`.")
    ...
    @Description("Template for Kafka Client `Pods`.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    @Description("Template for Kafka Client `Service`.")
    @DeprecatedProperty(description = "The Kafka Client service has been removed.")
    ...
    @Description("Template for the Kafka Client container")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    @Description("Template for the Kafka Client service account.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
