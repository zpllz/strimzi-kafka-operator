...
@EqualsAndHashCode
public class StrimziClientTemplate implements Serializable, UnknownPropertyPreserving {
    ...
    @Description("Template for Strimzi Client `Deployment`.")
    ...
    @Description("Template for Strimzi Client `Pods`.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    @Description("Template for Strimzi Client `Service`.")
    @DeprecatedProperty(description = "The Strimzi Clien service has been removed.")
    ...
    @Description("Template for the Strimzi Client container")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    ...
    @Description("Template for the Strimzi Client service account.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
